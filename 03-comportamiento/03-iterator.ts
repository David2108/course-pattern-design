...
function main(){
    ...
    const pokedez = new PokemonCollection();
    pokedez.addPokemon(new Pokemon("Bulbasaur", "Grass/Poison"));
    pokedez.addPokemon(new Pokemon("Charmander", "Fire"));
    pokedez.addPokemon(new Pokemon("Squirtle", "Water"));

    const iterator = pokedez.createIterator();
